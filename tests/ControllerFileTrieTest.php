...
class ControllerFileTrieTest extends PHPUnit_Framework_TestCase
{
    public function test_get_nearest_match()
    {
        ...
        $this->assertEquals('folder/file/index.php', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->matched_path, 'Failed routing to x/y/index.php');
        unlink(dirname(__FILE__) . '/running_test/folder/file/index.php');
        $this->assertEquals('folder/file.php', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->matched_path, 'Failed routing to x/y.php');
        rmdir(dirname(__FILE__) . '/running_test/folder/file');
        $this->assertEquals('folder/file.php', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->matched_path, 'Failed routing to x/y.php');
        unlink(dirname(__FILE__) . '/running_test/folder/file.php');
        $this->assertEquals('folder/index.php', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->matched_path, 'Failed routing to x/index.php');
        unlink(dirname(__FILE__) . '/running_test/folder/index.php');
        $this->assertEquals('folder.php', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->matched_path, 'Failed routing to x.php');
        rmdir(dirname(__FILE__) . '/running_test/folder');
        $this->assertEquals('folder.php', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->matched_path, 'Failed routing to x.php');
        unlink(dirname(__FILE__) . '/running_test/folder.php');
        rmdir(dirname(__FILE__) . '/running_test');
    ...
    {
        try {
            unlink(dirname(__FILE__) . '/running_test/folder/file/file2/index.php');
        } catch (\Exception $ex) {}
        try {
            rmdir(dirname(__FILE__) . '/running_test/folder/file/file2');
        } catch (\Exception $ex) {}
        try {
            unlink(dirname(__FILE__) . '/running_test/folder/file/index.php');
        } catch (\Exception $ex) {}
        ...
        mkdir(dirname(__FILE__) . '/running_test/folder');
        mkdir(dirname(__FILE__) . '/running_test/folder/file');
        mkdir(dirname(__FILE__) . '/running_test/folder/file/file2');
        file_put_contents(dirname(__FILE__) . '/running_test/folder/file/file2/index.php', '<?php class w { public $whoami = "w"; }');
        file_put_contents(dirname(__FILE__) . '/running_test/folder/file/index.php', '<?php class w { public $whoami = "w"; }');
        file_put_contents(dirname(__FILE__) . '/running_test/folder/file.php', '<?php class x { public $whoami = "x"; }');
        file_put_contents(dirname(__FILE__) . '/running_test/folder/index.php', '<?php class y { public $whoami = "y"; }');
        file_put_contents(dirname(__FILE__) . '/running_test/folder.php', '<?php class z { public $whoami = "z"; }');
        ...
        $this->assertEquals('', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->unmatched_path);
        unlink(dirname(__FILE__) . '/running_test/folder/file/file2/index.php');
        rmdir(dirname(__FILE__) . '/running_test/folder/file/file2');
        $this->assertEquals('file2', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->unmatched_path);
        unlink(dirname(__FILE__) . '/running_test/folder/file/index.php');
        $this->assertEquals('file2', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->unmatched_path);
        rmdir(dirname(__FILE__) . '/running_test/folder/file');
        $this->assertEquals('file2', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->unmatched_path);
        unlink(dirname(__FILE__) . '/running_test/folder/file.php');
        $this->assertEquals('file/file2', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->unmatched_path);
        unlink(dirname(__FILE__) . '/running_test/folder/index.php');
        $this->assertEquals('file/file2', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->unmatched_path);
        rmdir(dirname(__FILE__) . '/running_test/folder');
        $this->assertEquals('file/file2', $trie->find_closest_filesystem_match(dirname(__FILE__) . '/running_test/')->unmatched_path);
